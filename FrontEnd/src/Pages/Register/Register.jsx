    ...
    return (
        <section className="bg-gray-100 min-h-screen flex items-center justify-center">
            <div className="bg-white p-8 rounded shadow-lg w-full sm:w-96">
                <h1 className="text-2xl font-bold mb-4">Heasınız yoxdursa qeydiyyatdan keçin</h1>
          ...
          <div style={{display:"flex", gap:"10px"}}>
            ...
            />
            Admin
            <p>Kimi qeydiyyat ol</p>
          </div>
          {userType == "Admin" ? (
            <div className="mb-3">
              <label>Admin açarı</label>
              <input
                type="text"
              ...
              />
                    ...
                    <div className="flex flex-col gap-1">
                        <label htmlFor="photo" className="text-sm">Şəkil:</label>
                        <div {...getRootProps({ className: 'dropzone border rounded px-4 py-2 flex justify-center items-center cursor-pointer' })}>
                            ...
                            <p className="text-sm max-w-[300px] text-center truncate">
                                {photo ? photo.name : (isDragActive ? "Drop the files here..." : "Şəkli sürüşdürüb bura buraxın və ya klikləyərək fayllarınızdan şəkil seçin")}
                            </p>
                            {photo && (
                    ...
                    <button type="submit" disabled={isLoading} className="w-full bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded disabled:bg-gray-400 disabled:cursor-not-allowed">
                        {isLoading ? 'Creating User' : 'Qeydiyyatdan keçin'}
                    </button>
                </form>
